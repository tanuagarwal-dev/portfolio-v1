...
const Card = ({ data }: { data: CardProps}) => {
  return (
    <StyledWrapper>
      <div className="card lg:w-100 lg:h-48 md:w-100 w-80 overflow-visible md:h-48 h-64">
        <div className="content">
          ...
          <div className="front p-6 flex gap-4 flex-wrap items-center justify-center">
            {data.techStack.map((item, index) => (
                
                    <Button borderRadius="1.75rem" containerClassName='w-fit'
                    className="p-6 dark:bg-slate-900  dark:text-white border-neutral-200 dark:border-slate-800" key={index}>
                        {item}
                    </Button>
